...
PLS = []
img = Image.open(r"Improved-LSB-Steganography/images/in1.png")
[row, col] = img.size
...
def LsbEncoding(encodedText):
    ...
    for i in range(0, len(encodedText) * 3, 3):
        ...
        dr += 1
    img.save("Improved-LSB-Steganography/images/out1.png")
...
def LsbDecoding():
    ...
    decodedTextInBits = []
    stegoImage = Image.open(r"Improved-LSB-Steganography/images/out1.png")
